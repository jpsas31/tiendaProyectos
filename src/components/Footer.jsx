  ...
  return (
    <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded mt-10 max-md:px-0">
      {/* <nav className="grid grid-flow-col max-sm:grid-flow-row gap-4">
        ...
        <Link className="link link-hover text-2xl max-md:text-xl text-accent-content" to="/shop">
          Hire
        </Link>
  
        <Link className="link link-hover text-2xl max-md:text-xl text-accent-content" to="/add">
          Offer Services
        </Link>
